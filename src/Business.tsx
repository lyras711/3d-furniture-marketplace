...
const contactHref = `mailto:${businessEmail}?subject=${encodeURIComponent('Formivo B2B pilot conversation')}&body=${encodeURIComponent('Hi Formivo team,\n\nI would like to discuss a Formivo pilot for:\n\nCatalogue / category:\nStore:\nProposal:\n\nBest,')}`
...
export default function Business() {
  ...
  return <div className="showcase b2b">
    ...
    <header className="s-header b2b-header">
      <a className="s-wordmark" href="/" aria-label="Formivo home">formivo<span aria-hidden="true">✳</span></a>
      ...
      <a href="/planner" className="s-header-cta b2b-header-demo">Open customer demo <Arrow diagonal /></a>
    ...
    <main id="main">
      <section className="b2b-hero" aria-labelledby="business-heading">
        <div className="b2b-hero-copy">
          ...
          <div className="b2b-hero-actions"><a className="s-button s-button-dark" href={contactHref}>Contact us about a pilot <Arrow diagonal /></a><a className="s-text-link" href="#flow">See how it works <Arrow /></a></div>
        ...
        <div className="b2b-hero-art">
          <img src="/showcase-room.jpg" alt="Original Formivo render of a furnished room with a sofa, coffee table and warm daylight" width="1400" height="1250" fetchPriority="high" />
      ...
      <section className="b2b-pilot" id="pilot">
        <div className="b2b-pilot-visual"><img src="/showcase-sofa-haven.jpg" alt="Original Formivo render of the Haven sample sofa with a 220 centimetre measurement" width="900" height="720" /><span className="b2b-pilot-label">A PRODUCT IN CONTEXT</span><div className="b2b-measure"><span />220 CM<span /></div><span className="b2b-pilot-note">HAVEN / AUTHORED SAMPLE / 220 × 92 × 82 CM</span></div>
        <div className="b2b-pilot-copy"><span className="b2b-section-index">03 / START WITH A FOCUSED PILOT</span><h2>Begin where fit matters most.</h2><p>Pick a small set of products with high consideration, build the models properly, and learn what helps your customers move from “I like it” to “it works here.”</p><ul><li><b>01</b><span>Choose a focused catalogue and confirm model usage rights.</span></li><li><b>02</b><span>Agree dimensions, variants, data ownership and the handoff to your team.</span></li><li><b>03</b><span>Test room-scale discovery beside the store journey and measure what changes.</span></li></ul><a className="s-button s-button-acid" href={contactHref}>Email us about a pilot <Arrow diagonal /></a><small>Opens your email app with a short proposal prompt.</small></div>
      </section>

      <section className="b2b-section b2b-stack" id="integration">
        <div className="b2b-heading"><div><div className="b2b-section-index">04 / BUILT AROUND YOUR BUSINESS</div><h2>Useful before<br /><em>it is connected.</em></h2></div><p>Formivo is designed as a conversion layer around an existing furniture store—not a replacement for your catalogue, checkout or operational systems. Customers can browse your products in the room-scale viewer, then continue to your product, quote or checkout flow.</p></div>
        <div className="b2b-architecture" aria-label="Illustrative pilot architecture"><div><span>01</span><strong>Your catalogue</strong><small>Products · dimensions · variants</small></div><b aria-hidden="true">+</b><div className="b2b-architecture-highlight"><span>02</span><strong>Formivo spatial layer</strong><small>Room builder · product models · 2D / 3D</small></div><b aria-hidden="true">→</b><div><span>03</span><strong>Your commercial flow</strong><small>Store · quote · sales handoff</small></div></div>
      ...
      <section className="b2b-final"><div className="b2b-final-top"><span className="b2b-section-index">MAKE YOUR CATALOGUE FEEL CLOSER TO HOME.</span><span aria-hidden="true">↙</span></div><h2>Show the piece.<br />Sell the <em>possibility.</em></h2><div className="b2b-final-bottom"><p>Start with a focused range.<br />Learn what the room changes.</p><div><a className="s-button s-button-dark" href={contactHref}>Contact us about a pilot <Arrow diagonal /></a><a className="s-text-link" href="/planner">Open the working planner <Arrow /></a></div></div></section>
    </main>

    <footer className="b2b-footer"><a className="s-wordmark" href="/" aria-label="Formivo home">formivo<span aria-hidden="true">✳</span></a><p>Spatial shopping tools<br />for furniture businesses.</p><div><a href="/planner">Open the planner <span aria-hidden="true">↗</span></a><a href="#main">Back to top <span aria-hidden="true">↑</span></a></div><div className="b2b-footer-base"><span>© {new Date().getFullYear()} FORMIVO</span><span>BUSINESS PROTOTYPE · PILOT CONVERSATIONS WELCOME</span></div></footer>
