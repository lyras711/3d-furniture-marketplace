...
export default function Showcase() {
  ...
  return <div className="showcase">
    ...
    <header className="s-header">
      ...
      <nav className={menuOpen ? 's-nav s-nav-open' : 's-nav'} aria-label="Main navigation"><a href="#experience" onClick={() => setMenuOpen(false)}>The experience</a><a href="#retailers" onClick={() => setMenuOpen(false)}>For retailers</a><a href="/" onClick={() => setMenuOpen(false)}>For businesses</a><a href="#vision" onClick={() => setMenuOpen(false)}>The bigger picture</a></nav>
    ...
    <main id="main">
      ...
      <section className="s-faq s-section s-reveal"><div><span className="s-section-index">A FEW THINGS, UP FRONT.</span><h2>Good questions.<br /><em>Straight answers.</em></h2></div><div>{[
        ['Can I actually use Formivo today?', 'Yes. The working browser prototype lets you build custom rooms, arrange nine sample products, explore 2D and 3D views, render interiors, save locally, share project links, and download shopping lists and quote drafts. No account is needed.'],
        ...
        ['Are my plans private?', 'The planner saves on your device, not to a Formivo account. Shared links contain your project data, and downloaded drafts may contain details you enter. Share them only with people you trust. This showcase does not submit your partnership details to a server.'],
